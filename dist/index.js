...
router.post('/api/currentByCoordinates', (ctx) => __awaiter(this, void 0, void 0, function* () {
    ...
    const forecast = yield owmApi_1.getCurrentByCoordinates(lattitude, longitude);
